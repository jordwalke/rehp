...
var pG = Js_of_ocaml_Js[50][1];
var mutationObserver = function(t0, param) {return t0.MutationObserver;}(pG, pF
);
...
function observe(node, f, child_list, attributes, character_data, subtree, attribute_old_value, character_data_old_value, attribute_filter, param) {
  ...
  var pH = 0;
  var pI = runtime["caml_js_wrap_callback"](f);
  var obs = function(t19, t18, param) {return new t19(t18);}(mutationObserver, pI, pH
  );
  ...
  opt_iter(
    ...
    function(v) {
      ...
      return function(t17, t16, param) {t17.childList = t16;return 0;}(cfg, v, pR
      );
    }
  );
  opt_iter(
    ...
    function(v) {
      ...
      return function(t15, t14, param) {t15.attributes = t14;return 0;}(cfg, v, pQ
      );
    }
  );
  opt_iter(
    ...
    function(v) {
      ...
      return function(t13, t12, param) {t13.characterData = t12;return 0;}(cfg, v, pP
      );
    }
  );
  opt_iter(
    ...
    function(v) {
      ...
      return function(t11, t10, param) {t11.subtree = t10;return 0;}(cfg, v, pO
      );
    }
  );
  opt_iter(
    ...
    function(v) {
      ...
      return function(t9, t8, param) {t9.attributeOldValue = t8;return 0;}(cfg, v, pN
      );
    }
  );
  opt_iter(
    ...
    function(v) {
      ...
      return function(t7, t6, param) {t7.characterDataOldValue = t6;return 0;}(cfg, v, pM
      );
    }
  );
  opt_iter(
    ...
    function(l) {
      ...
      var pL = runtime["caml_js_from_array"](caml_call1(Array[12], l));
      return function(t5, t4, param) {t5.attributeFilter = t4;return 0;}(cfg, pL, pK
      );
    }
  );
  function pJ(x) {
  ...
  (function(t3, t1, t2, param) {return t3.observe(t1, t2);}(obs, node, cfg, pJ
   ));
  return obs;
}
