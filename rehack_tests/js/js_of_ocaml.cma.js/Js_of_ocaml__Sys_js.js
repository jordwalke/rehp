...
if (runtime["caml_string_equal"](Js_of_ocaml_Lib_version[2], cst)) var js_of_ocaml_version = Js_of_ocaml_Lib_version[1];
  ...
  var pT = caml_call2(Pervasives[16], cst__0, Js_of_ocaml_Lib_version[2]);
...
function pR(pX, pW) {return runtime["caml_create_file"](pX, pW);}

function pS(pV) {return runtime["caml_read_file_content"](pV);}

var Js_of_ocaml_Sys_js = [
  0,
  set_channel_flusher,
  set_channel_filler,
  function(pU) {return runtime["caml_list_mount_point"](pU);},
  unmount,
  mount,
  pS,
  pR,
