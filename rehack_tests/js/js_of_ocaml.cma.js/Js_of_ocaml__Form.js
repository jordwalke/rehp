...
function get_select_val(elt) {
  if (have_content(elt)) {
    ...
    if (function(t15, param) {return t15.multiple;}(elt, mb) | 0) {
      var mc = function(i) {
        function mm(x) {
          return caml_call1(caml_get_public_method(x, -977287917, 211), x);
        }
        function mn(x) {
          return caml_call1(caml_get_public_method(x, -536988834, 212), x);
        }
      ...
      var me = function(x) {
        return caml_call1(caml_get_public_method(x, -536988834, 214), x);
      };
      var mf = function(t10, param) {return t10.options;}(elt, me);
      var mg = function(t11, param) {return t11.length;}(mf, md);
      var options = caml_call2(Array[2], mg, mc);
      var mh = caml_call1(Array[11], options);
      return filter_map(
        function(param) {
          if (param) {
            var e = param[1];
            var mk = function(x) {
              return caml_call1(caml_get_public_method(x, 829237851, 215), x);
            };
            if (function(t9, param) {return t9.selected;}(e, mk) | 0) {
              var ml = function(x) {
                return caml_call1(caml_get_public_method(x, 834174833, 216), x
                );
              };
              return [
                0,
  ...
  if (have_content(elt)) {
    ...
    if (caml_string_notequal(match, cst_checkbox)) {
      if (! caml_string_notequal(match, cst_file)) {
        ...
        var lX = function(x) {
          return caml_call1(caml_get_public_method(x, 10018423, 223), x);
        };
        var lY = function(t25, param) {return t25.files;}(elt, lX);
        var match__0 = caml_call1(Js_of_ocaml_Js[6][10], lY);
        if (match__0) {
          var list = match__0[1];
          var lZ = function(x) {
            return caml_call1(caml_get_public_method(x, 520590566, 224), x);
          };
          if (0 === function(t24, param) {return t24.length;}(list, lZ)) {return [0,[0,name,[0,-976970511,""]],0];}
          var l0 = function(x) {
            return caml_call1(caml_get_public_method(x, 445440528, 225), x);
          };
          var l1 = function(t23, param) {return t23.multiple;}(elt, l0);
          var match__1 = caml_call1(Js_of_ocaml_Js[6][10], l1);
          if (match__1) {
            if (0 !== match__1[1]) {
              var l5 = function(i) {
                function l_(x) {
              ...
              var l6 = function(x) {
                return caml_call1(caml_get_public_method(x, 520590566, 228), x
                );
              };
              var l7 = function(t20, param) {return t20.length;}(list, l6);
              var l8 = caml_call2(Array[2], l7, l5);
              var l9 = caml_call1(Array[11], l8);
              return filter_map(
                function(f) {
          ...
          var l2 = function(x) {
            return caml_call1(caml_get_public_method(x, -977287917, 226), x);
          };
          var l3 = 0;
          var l4 = function(t19, t18, param) {return t19.item(t18);}(list, l3, l2
          );
          var match__2 = caml_call1(Js_of_ocaml_Js[5][10], l4);
          if (match__2) {
            var file = match__2[1];
...
function form_elements(get, form) {
  ...
  var lK = caml_call2(Array[2], length, lJ);
  var elements = caml_call1(Array[11], lK);
  function lL(param) {
    if (param) {
      var v = param[1];
      var match = caml_call1(Js_of_ocaml_Dom_html[109], v);
      switch (match[0]) {
        case 31:
          var v__0 = match[1];
  ...
  var lM = caml_call2(List[17], lL, elements);
  var contents = caml_call1(List[14], lM);
  return contents;
}
...
function empty_form_contents(param) {
  var ly = caml_call1(Js_of_ocaml_Js[4], formData);
  var match = caml_call1(Js_of_ocaml_Js[6][10], ly);
  if (match) {
    var constr = match[1];
    var lz = 0;
