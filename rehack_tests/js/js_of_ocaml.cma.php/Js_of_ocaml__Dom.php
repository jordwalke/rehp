  ...
  private static function load($joo_global_object) {
    ...
    $list_of_nodeList = function(dynamic $nodeList) use ($Js_of_ocaml_Js,$List,$call1,$caml_get_public_method) {
      ...
      $add_item = function(dynamic $acc, dynamic $i) use ($Js_of_ocaml_Js,$List,$call1,$caml_get_public_method,$length,$nodeList) {
        ...
        for (;;) {
          if ($i__0 < $length) {
            $fX = function(dynamic $x) use ($call1,$caml_get_public_method) {
              return $call1($caml_get_public_method($x, -977287917, 49), $x);
            };
            $fY = (function(dynamic $t1, dynamic $t0, dynamic $param) {return $t1->item($t0);
             })($nodeList, $i__0, $fX);
            $match = $call1($Js_of_ocaml_Js[5][10], $fY);
            if ($match) {
              $e = $match[1];
              $i__1 = (int) ($i__0 + 1);
    ...
    $appendChild = function(dynamic $p, dynamic $n) use ($call1,$caml_get_public_method) {
      $fV = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, 36716898, 50), $x);
      };
    ...
    $removeChild = function(dynamic $p, dynamic $n) use ($call1,$caml_get_public_method) {
      $fU = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, -1007843656, 51), $x);
      };
    ...
    $replaceChild = function(dynamic $p, dynamic $n, dynamic $o) use ($call1,$caml_get_public_method) {
      $fT = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, 961057992, 52), $x);
      };
    ...
    $insertBefore = function(dynamic $p, dynamic $n, dynamic $o) use ($call1,$caml_get_public_method) {
      $fS = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, 281001112, 53), $x);
      };
    ...
    $nodeType = function(dynamic $e) use ($call1,$caml_get_public_method) {
      $fR = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, -158969380, 54), $x);
      };
    ...
    $cast = function(dynamic $e, dynamic $t) use ($Js_of_ocaml_Js,$call1,$caml_get_public_method) {
      $fQ = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, -158969380, 55), $x);
      };
    ...
    $text = function(dynamic $e) use ($Js_of_ocaml_Js,$call1,$caml_get_public_method) {
      $fO = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, -158969380, 56), $x);
      };
      if (
        3 !==
          (function(dynamic $t15, dynamic $param) {return $t15->nodeType;})($e, $fO)
      ) {
        $fP = function(dynamic $x) use ($call1,$caml_get_public_method) {
          return $call1($caml_get_public_method($x, -158969380, 57), $x);
        };
        if (
          4 !==
    ...
    $handler = function(dynamic $f) use ($Js_of_ocaml_Js,$call1,$caml_get_public_method,$window_event) {
      $fK = function(dynamic $e) use ($Js_of_ocaml_Js,$call1,$caml_get_public_method,$f,$window_event) {
        $fL = $call1($Js_of_ocaml_Js[2], $e);
        if ($call1($Js_of_ocaml_Js[5][5], $fL)) {
          $res = $call1($f, $e);
          if (1 - (int) $res) {
            $fM = function(dynamic $x) use ($call1,$caml_get_public_method) {
              return $call1($caml_get_public_method($x, -408605495, 58), $x);
            };
        ...
        $res__0 = $call1($f, $e__0);
        if (1 - (int) $res__0) {
          $fN = function(dynamic $x) use ($call1,$caml_get_public_method) {
            return $call1($caml_get_public_method($x, 1049971873, 59), $x);
          };
      ...
      return $call1($Js_of_ocaml_Js[2], $fK);
    };
    $full_handler = function(dynamic $f) use ($Js_of_ocaml_Js,$call1,$call2,$caml_get_public_method,$runtime,$window_event) {
      $fG = $runtime["caml_js_wrap_meth_callback_unsafe"](
        function(dynamic $this__0, dynamic $e) use ($Js_of_ocaml_Js,$call1,$call2,$caml_get_public_method,$f,$window_event) {
          $fH = $call1($Js_of_ocaml_Js[2], $e);
          if ($call1($Js_of_ocaml_Js[5][5], $fH)) {
            $res = $call2($f, $this__0, $e);
            if (1 - (int) $res) {
              $fI = function(dynamic $x) use ($call1,$caml_get_public_method) {
                return $call1($caml_get_public_method($x, -408605495, 60), $x);
              };
          ...
          if (1 - (int) $res__0) {
            $fJ = function(dynamic $x) use ($call1,$caml_get_public_method) {
              return $call1($caml_get_public_method($x, 1049971873, 61), $x);
            };
      ...
      return $call1($Js_of_ocaml_Js[2], $fG);
    };
    $invoke_handler = function(dynamic $f, dynamic $this__0, dynamic $event) {return $f->call($this__0, $event);
    };
    $eventTarget = function(dynamic $e) use ($Assert_failure,$Js_of_ocaml_Js,$Not_found,$call1,$call2,$caml_get_public_method,$e_,$runtime) {
      $fu = function(dynamic $param) use ($Js_of_ocaml_Js,$Not_found,$call1,$call2,$caml_get_public_method,$e,$runtime) {
        $fD = function(dynamic $param) use ($Not_found,$runtime) {
          throw $runtime["caml_wrap_thrown_exception"]($Not_found) as \Throwable;
        };
        $fE = function(dynamic $x) use ($call1,$caml_get_public_method) {
          return $call1($caml_get_public_method($x, -1021537224, 62), $x);
        };
        $fF = (function(dynamic $t27, dynamic $param) {return $t27->srcElement;
         })($e, $fE);
        return $call2($Js_of_ocaml_Js[5][8], $fF, $fD);
      };
      $fv = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, 116192081, 63), $x);
      };
      $fw = (function(dynamic $t26, dynamic $param) {return $t26->target;})($e, $fv);
      $target = $call2($Js_of_ocaml_Js[5][8], $fw, $fu);
      $fx = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, -420195839, 64), $x);
      };
      ...
      if (
        ...
        $fz = function(dynamic $x) use ($call1,$caml_get_public_method) {
          return $call1($caml_get_public_method($x, -158969380, 65), $x);
        };
        if (
          3 ===
          ...
          $fB = function(dynamic $x) use ($call1,$caml_get_public_method) {
            return $call1($caml_get_public_method($x, -400811956, 66), $x);
          };
          $fC = (function(dynamic $t23, dynamic $param) {return $t23->parentNode;
           })($target, $fB);
          return $call2($Js_of_ocaml_Js[5][8], $fC, $fA);
        }
        return $target;
      }
      return $target;
    ...
    (dynamic $e, dynamic $typ, dynamic $h, dynamic $capt) use ($Js_of_ocaml_Js,$call1,$caml_get_public_method,$runtime) {
      $ff = $Js_of_ocaml_Js[3];
      $fg = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, -245101619, 67), $x);
      };
      if (
        (function(dynamic $t44, dynamic $param) {return $t44->addEventListener;
         })($e, $fg) === $ff
      ) {
        $fh = function(dynamic $x) use ($call1,$caml_get_public_method) {
          return $call1($caml_get_public_method($x, -942667500, 68), $x);
        };
        $fi = "on";
        ...
        $fj = function(dynamic $x) use ($call1,$caml_get_public_method) {
          return $call1($caml_get_public_method($x, -362647019, 69), $x);
        };
        ...
        return function(dynamic $param) use ($call1,$callback,$caml_get_public_method,$e,$ev) {
          $fm = function(dynamic $x) use ($call1,$caml_get_public_method) {
            return $call1($caml_get_public_method($x, 681618887, 70), $x);
          };
          return (function
      ...
      $fk = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, -245101619, 71), $x);
      };
      ((function
      ...
      return function(dynamic $param) use ($call1,$caml_get_public_method,$capt,$e,$h,$typ) {
        $fl = function(dynamic $x) use ($call1,$caml_get_public_method) {
          return $call1($caml_get_public_method($x, -713717814, 72), $x);
        };
        return (function
    ...
    $preventDefault = function(dynamic $ev) use ($Js_of_ocaml_Js,$call1,$caml_get_public_method) {
      $fa = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, -408605495, 73), $x);
      };
      $fb = (function(dynamic $t48, dynamic $param) {return $t48->preventDefault;
       })($ev, $fa);
      if ($call1($Js_of_ocaml_Js[6][5], $fb)) {
        $fc = function(dynamic $x) use ($call1,$caml_get_public_method) {
          return $call1($caml_get_public_method($x, -408605495, 74), $x);
        };
        return (function(dynamic $t47, dynamic $param) {return $t47->preventDefault();
         })($ev, $fc);
      }
      $fd = function(dynamic $x) use ($call1,$caml_get_public_method) {
        return $call1($caml_get_public_method($x, 1049971873, 75), $x);
      };
      $fe = ! ! 0;
