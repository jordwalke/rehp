...
final class Buffer {
  ...
  private static function load($joo_global_object) {
    ...
    $contents = function(dynamic $b) use ($Bytes,$caml_call3) {
      return $caml_call3($Bytes[8], $b[1], 0, $b[2]);
    };
    $to_bytes = function(dynamic $b) use ($Bytes,$caml_call3) {
      return $caml_call3($Bytes[7], $b[1], 0, $b[2]);
    };
    $sub = function(dynamic $b, dynamic $ofs, dynamic $len) use ($Bytes,$Pervasives,$caml_call1,$caml_call3,$cst_Buffer_sub) {
      if (0 <= $ofs) {
        if (0 <= $len) {
          if (! ((int) ($b[2] - $len) < $ofs)) {
    ...
    $blit = function
    (dynamic $src, dynamic $srcoff, dynamic $dst, dynamic $dstoff, dynamic $len) use ($Pervasives,$caml_call1,$caml_ml_bytes_length,$cst_Buffer_blit,$runtime) {
      if (0 <= $len) {
        if (0 <= $srcoff) {
    ...
    $nth = function(dynamic $b, dynamic $ofs) use ($Pervasives,$caml_call1,$cst_Buffer_nth,$runtime) {
      if (0 <= $ofs) {
        if (! ($b[2] <= $ofs)) {
    ...
    $resize = function(dynamic $b, dynamic $more) use ($Bytes,$Pervasives,$Sys,$caml_call1,$caml_call5,$caml_create_bytes,$cst_Buffer_add_cannot_grow_buffer) {
      $len = $b[3];
    ...
    $add_utf_8_uchar = function(dynamic $b, dynamic $u) use ($Assert_failure,$Uchar,$add_char,$caml_bytes_unsafe_set,$caml_call1,$hl,$hm,$resize,$runtime,$unsigned_right_shift_32) {
    ...
    $add_utf_16be_uchar = function(dynamic $b, dynamic $u) use ($Assert_failure,$Uchar,$caml_bytes_unsafe_set,$caml_call1,$hn,$ho,$resize,$runtime,$unsigned_right_shift_32) {
      $u__0 = $caml_call1($Uchar[10], $u);
      if (0 <= $u__0) {
        if (65535 < $u__0) {
          if (1114111 < $u__0) {
    ...
    $add_utf_16le_uchar = function(dynamic $b, dynamic $u) use ($Assert_failure,$Uchar,$caml_bytes_unsafe_set,$caml_call1,$hp,$hq,$resize,$runtime,$unsigned_right_shift_32) {
      $u__0 = $caml_call1($Uchar[10], $u);
      if (0 <= $u__0) {
        if (65535 < $u__0) {
          if (1114111 < $u__0) {
    ...
    (dynamic $b, dynamic $s, dynamic $offset, dynamic $len) use ($Bytes,$Pervasives,$caml_call1,$caml_call5,$caml_ml_string_length,$cst_Buffer_add_substring_add_subbytes,$resize) {
      $hw = $offset < 0 ? 1 : (0);
      if ($hw) {
        $hx = $hw;
      }
    ...
    (dynamic $b, dynamic $s, dynamic $offset, dynamic $len) use ($Bytes,$add_substring,$caml_call1) {
      return $add_substring($b, $caml_call1($Bytes[42], $s), $offset, $len);
    };
    $add_string = function(dynamic $b, dynamic $s) use ($Bytes,$caml_call5,$caml_ml_string_length,$resize) {
    ...
    $add_bytes = function(dynamic $b, dynamic $s) use ($Bytes,$add_string,$caml_call1) {
    ...
    $add_channel_rec = function(dynamic $b, dynamic $ic, dynamic $len) use ($End_of_file,$Pervasives,$caml_call4,$runtime) {
      $len__0 = $len;
      for (;;) {
        $hv = 0 < $len__0 ? 1 : (0);
        if ($hv) {
    ...
    $add_channel = function(dynamic $b, dynamic $ic, dynamic $len) use ($Pervasives,$Sys,$add_channel_rec,$caml_call1,$cst_Buffer_add_channel,$resize) {
      $ht = $len < 0 ? 1 : (0);
    ...
    $output_buffer = function(dynamic $oc, dynamic $b) use ($Pervasives,$caml_call4) {
    ...
    $find_ident = function(dynamic $s, dynamic $start, dynamic $lim) use ($Not_found,$String,$advance_to_closing,$advance_to_non_alpha,$caml_call3,$caml_string_get,$closing,$runtime) {
      if ($lim <= $start) {
        throw $runtime["caml_wrap_thrown_exception"]($Not_found) as \Throwable;
      }
    ...
    $add_substitute = function(dynamic $b, dynamic $f, dynamic $s) use ($add_char,$add_string,$caml_call1,$caml_ml_string_length,$caml_string_get,$find_ident) {
      $lim = $caml_ml_string_length($s);
      $subst = function(dynamic $previous, dynamic $i) use ($add_char,$add_string,$b,$caml_call1,$caml_string_get,$f,$find_ident,$lim,$s) {
    ...
    $truncate = function(dynamic $b, dynamic $len) use ($Pervasives,$caml_call1,$cst_Buffer_truncate,$length) {
