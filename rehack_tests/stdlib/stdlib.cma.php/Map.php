    ...
    $Map = Vector{
      ...
      (dynamic $Ord) ==> {
        ...
        $create = (dynamic $l, dynamic $x, dynamic $d, dynamic $r) ==> {
          $hl = $height($l);
          $hr = $height($r);
          $J_ = $hr <= $hl ? (int) ($hl + 1) : ((int) ($hr + 1));
          return Vector{0, $l, $x, $d, $r, $J_};
        };
          ...
          if ((int) ($hr + 2) < $hl) {
            if ($l) {
              ...
              if ($lr) {
                ...
                $lrl = $lr[1];
                $F_ = $create($lrr, $x, $d, $r);
                return $create($create($ll, $lv, $ld, $lrl), $lrv, $lrd, $F_);
              }
          ...
          if ((int) ($hl + 2) < $hr) {
            if ($r) {
              ...
              if ($rl) {
                ...
                $rlv = $rl[2];
                $rll = $rl[1];
                $H_ = $create($rlr, $rv, $rd, $rr);
                return $create($create($l, $x, $d, $rll), $rlv, $rld, $H_);
              }
              return $call1($Pervasives[1], $cst_Map_bal__1);
            }
            return $call1($Pervasives[1], $cst_Map_bal__2);
          }
          $I_ = $hr <= $hl ? (int) ($hl + 1) : ((int) ($hr + 1));
          return Vector{0, $l, $x, $d, $r, $I_};
        };
        $empty = 0;
            ...
            if ($param__1) {
              ...
              if ($call1($f, $v__0)) {
                ...
                for (;;) {
                  ...
                  return Vector{0, Vector{0, $v0, $d0}};
                }
              }
              $param__1 = $r__0;
              continue;
        ...
        $max_binding_opt = (dynamic $param) ==> {
          ...
          for (;;) {
            if ($param__0) {
              ...
              return Vector{0, Vector{0, $x_, $w_}};
            }
            return 0;
          }
        };
        $remove_min_binding->contents = (dynamic $param) ==> {
          ...
          if ($param) {
            ...
            if ($u_) {
              ...
              $d = $param[3];
              $v = $param[2];
              return $bal($remove_min_binding->contents($u_), $v, $d, $r);
            }
            $r__0 = $param[4];
            return $r__0;
          }
        ...
        $for_all->contents = (dynamic $p, dynamic $param) ==> {
          ...
          for (;;) {
            if ($param__0) {
              ...
              $r_ = $call2($p, $v, $d);
              if ($r_) {
                $s_ = $for_all->contents($p, $l);
                if ($s_) {$param__0 = $r;continue;}
                $t_ = $s_;
              }
              else {$t_ = $r_;}
              return $t_;
          ...
          for (;;) {
            if ($param__0) {
              ...
              if ($o_) {
                ...
                $q_ = $exists->contents($p, $l);
                if (! $q_) {$param__0 = $r;continue;}
                $p_ = $q_;
              }
              return $p_;
            }
        ...
        $merge->contents = (dynamic $f, dynamic $s1, dynamic $s2) ==> {
          ...
          if ($s1) {
            ...
            if ($height($s2) <= $h1) {
              ...
              $d2 = $match[2];
              $l2 = $match[1];
              $k_ = $merge->contents($f, $r1, $r2);
              $l_ = $call3($f, $v1, Vector{0, $d1}, $d2);
          ...
          if ($s2) {
            ...
            $d1__0 = $match__0[2];
            $l1__0 = $match__0[1];
            $m_ = $merge->contents($f, $r1__0, $r2__0);
            $n_ = $call3($f, $v2, $d1__0, Vector{0, $d2__0});
            return $concat_or_join(
        ...
        $partition->contents = (dynamic $p, dynamic $param) ==> {
          ...
          if ($param) {
            ...
            if ($pvd) {
              $i_ = $concat($lf, $rf);
              return Vector{0, $join->contents($lt, $v, $d, $rt), $i_};
            }
            $j_ = $join->contents($lf, $v, $d, $rf);
            return Vector{0, $concat($lt, $rt), $j_};
          }
          return $c_;
        };
        ...
        $compare = (dynamic $cmp, dynamic $m1, dynamic $m2) ==> {
          ...
          $e2__1 = null;
          $e1__1 = null;
          $e2__2 = $cons_enum($m2, 0);
          $e1__2 = $cons_enum($m1, 0);
          $e1 = $e1__2;
          $e2 = $e2__2;
          for (;;) {
            if ($e1) {
        ...
        $cardinal->contents = (dynamic $param) ==> {
          ...
          if ($param) {
            $r = $param[4];
            $l = $param[1];
            $e_ = $cardinal->contents($r);
            return (int) ((int) ($cardinal->contents($l) + 1) + $e_);
          }
          return 0;
        };
