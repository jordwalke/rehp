...
function close_in(ib) {
  ...
  if (typeof bx_ === "number") return 0;
    ...
    if (0 === bx_[0]) {var ic = bx_[1];return call1(Stdlib[93], ic);}
    var ic__0 = bx_[2];
...
function memo_from_ic(scan_close_ic, ic) {
  try {var bv_ = call2(Stdlib_list[41], ic, memo[1]);return bv_;}
  catch(bw_) {
...
function token_int_literal(conv, ib) {
  switch (conv) {
    case 0:
      var bo_ = token_string(ib);
      var tok = call2(Stdlib[28], cst_0b, bo_);
      break;
    case 3:
      var bp_ = token_string(ib);
      var tok = call2(Stdlib[28], cst_0o, bp_);
      break;
    case 4:
      var bq_ = token_string(ib);
      var tok = call2(Stdlib[28], cst_0u, bq_);
      break;
    case 5:
      var br_ = token_string(ib);
      var tok = call2(Stdlib[28], cst_0x, br_);
      break;
    default:
...
function scan_float(width, precision, ib) {
  ...
  if (46 === c) {
    var width__1 = store_char(width__0, ib, c);
    var precision__0 = call2(Stdlib[16], width__1, precision);
...
function scan_hex_float(width, precision, ib) {
  ...
  if (78 <= c) {
    ...
    if (30 < switcher >>> 0) {
      if (! (32 <= switcher)) {
        var width__1 = store_char(width__0, ib, c);
        var a5_ = 0 === width__1 ? 1 : 0;
        var a6_ = a5_ ? a5_ : end_of_input(ib);
    ...
    if (48 === c) {
      ...
      var a9_ = 0 === width__3 ? 1 : 0;
      var a__ = a9_ ? a9_ : end_of_input(ib);
            ...
            if (! end_of_input(ib)) {
              ...
              if (46 === c__0) {
                ...
                if (0 === width__6) var switch__2 = 0;
                  ...
                  if (80 === match__0) var switch__3 = 0;
                    ...
                    var precision__0 = call2(Stdlib[16], width__6, precision);
              ...
              if (0 !== width__8) {
                if (! end_of_input(ib)) {
                  ...
                  var bb_ = 0 === width__9 ? 1 : 0;
                  var bc_ = bb_ ? bb_ : end_of_input(ib);
  ...
  if (switch__0) {
    var width__2 = store_char(width__0, ib, c);
    var a7_ = 0 === width__2 ? 1 : 0;
    var a8_ = a7_ ? a7_ : end_of_input(ib);
...
function scan_caml_float(width, precision, ib) {
  ...
  if (49 <= c) {
    if (! (58 <= c)) {
      var width__1 = store_char(width__0, ib, c);
      var aN_ = 0 === width__1 ? 1 : 0;
      var aO_ = aN_ ? aN_ : end_of_input(ib);
      if (aO_) {bad_float(0);}
    ...
    var width__2 = store_char(width__0, ib, c);
    var aP_ = 0 === width__2 ? 1 : 0;
    var aQ_ = aP_ ? aP_ : end_of_input(ib);
    if (aQ_) {bad_float(0);}
    var c__0 = peek_char(ib);
    if (88 !== c__0) {
      if (120 !== c__0) {
    ...
    var aR_ = 0 === width__3 ? 1 : 0;
    var aS_ = aR_ ? aR_ : end_of_input(ib);
    if (aS_) {bad_float(0);}
    var width__4 = scan_hexadecimal_int(width__3, ib);
    var aT_ = 0 === width__4 ? 1 : 0;
    var aU_ = aT_ ? aT_ : end_of_input(ib);
    if (aU_) {bad_float(0);}
    var c__1 = peek_char(ib);
    ...
    if (32 < switcher >>> 0) if (-34 === switcher) {
      ...
      if (0 === width__5) var switch__1 = 0;
        ...
        if (80 === match) var switch__2 = 0;
          ...
          var precision__0 = call2(Stdlib[16], width__5, precision);
    ...
    if (0 !== width__8) {
      if (! end_of_input(ib)) {
        ...
        var aV_ = 0 === width__9 ? 1 : 0;
        var aW_ = aV_ ? aV_ : end_of_input(ib);
...
function scan_caml_string(width, ib) {
  function find_stop__0(counter, width) {
    ...
    for (; ; ) {
      ...
      if (92 === c) {
        var az_ = ignore_char(width__0, ib);
        if (counter < 50) {
...
function take_format_readers__0(counter, k, fmt) {
  ...
  for (; ; ) if (
    ...
    case 14:
      var rest = fmt__0[3];
      var fmtty = fmt__0[2];
      var am_ = call1(CamlinternalFormat[22], fmtty);
      var an_ = call1(CamlinternalFormatBasics[2], am_);
      if (counter < 50) {
        var counter__1 = counter + 1 | 0;
...
function take_fmtty_format_readers__0(counter, k, fmtty, fmt) {
  ...
  for (; ; ) if (
    ...
    case 9:
      ...
      var ty2 = fmtty__0[2];
      var ty1 = fmtty__0[1];
      var al_ = call1(CamlinternalFormat[22], ty1);
      var ty = call2(CamlinternalFormat[23], al_, ty2);
...
function make_scanf(ib, fmt, readers) {
  ...
  for (; ; ) if (
    ...
    case 9:
      ...
      var pad__7 = fmt__0[1];
      var scan__8 = function(param, af_, ib) {return scan_bool(ib);};
      return pad_prec_scanf(
        ib,
        rest__12,
        readers,
    ...
    case 11:
      var fmt__3 = fmt__0[2];
      var str__0 = fmt__0[1];
      var N_ = function(ae_) {return check_char(ib, ae_);};
    ...
    case 13:
      ...
      var s = token_string(ib);
      try {var P_ = call2(CamlinternalFormat[14], s, fmtty);var fmt__5 = P_;}
      catch(exn) {
    ...
    case 14:
      ...
      try {
        var match__2 = call2(CamlinternalFormat[13], 0, s__0);
        var fmt__8 = match__2[1];
        var match__3 = call2(CamlinternalFormat[13], 0, s__0);
        var fmt__9 = match__3[1];
        var T_ = call1(CamlinternalFormat[22], fmtty__0);
        var U_ = call1(CamlinternalFormatBasics[2], T_);
        var fmt__10 = call2(CamlinternalFormat[12], fmt__9, U_);
        var V_ = call1(CamlinternalFormatBasics[2], fmtty__0);
        var W_ = call2(CamlinternalFormat[12], fmt__8, V_);
        var fmt__7 = W_;
        var fmt__6 = fmt__10;
      }
      catch(exn) {
    ...
    case 17:
      ...
      var X_ = call1(CamlinternalFormat[17], formatting_lit);
      var Y_ = function(ad_) {return check_char(ib, ad_);};
    ...
    case 20:
      ...
      var width = width_of_pad_opt(ac_);
...
function kscanf(ib, ef, param) {
  ...
  function k(readers, f) {
    reset_token(ib);
    try {var I_ = [0,make_scanf(ib, fmt, readers)];var C_ = I_;}
    catch(exc) {
      exc = runtime["caml_wrap_exception"](exc);
      if (exc[1] === Scan_failure) var switch__0 = 0;
      else if (exc[1] === Stdlib[7]) var switch__0 = 0;
      else if (exc === Stdlib[12]) var switch__0 = 0;
      else {
        if (exc[1] !== Stdlib[6]) {
          throw caml_wrap_thrown_exception_reraise(exc);
        }
        var msg = exc[2];
        var D_ = call1(Stdlib_string[13], str);
        var E_ = call2(Stdlib[28], D_, cst__1);
        var F_ = call2(Stdlib[28], cst_in_format, E_);
        var G_ = call2(Stdlib[28], msg, F_);
        var H_ = call1(Stdlib[1], G_);
        var B_ = H_;
        var switch__0 = 1;
      }
      if (! switch__0) {var B_ = [1,exc];}
      var C_ = B_;
    }
    if (0 === C_[0]) {var args = C_[1];return apply(f, args);}
    var exc = C_[1];
...
function bscanf_format(ib, format, f) {
  ...
  try {var A_ = call2(CamlinternalFormat[15], str, format);var fmt = A_;}
  catch(exn) {
    exn = runtime["caml_wrap_exception"](exn);
    if (exn[1] !== Stdlib[7]) {throw caml_wrap_thrown_exception_reraise(exn);}
    var msg = exn[2];
    var z_ = bad_input(msg);
    var fmt = z_;
  }
  return call1(f, fmt);
}
