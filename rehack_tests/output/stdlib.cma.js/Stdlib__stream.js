...
var cst_Stdlib_Stream_Failure = string("Stdlib.Stream.Failure");
var cst_Stdlib_Stream_Error = string("Stdlib.Stream.Error");
...
var Failure = [248,cst_Stdlib_Stream_Failure,caml_fresh_oo_id(0)];
...
function fill_buff(b) {
  b[3] = call4(Stdlib[84], b[1], b[2], 0, caml_ml_bytes_length(b[2]));
  b[4] = 0;
  return 0;
}
...
function of_list(l) {
  ...
  return [0,[0,0,call3(Stdlib_list[22], i_, l, h_)]];
}
