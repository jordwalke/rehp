...
var a_ = call1(Stdlib[33], 2);
var b_ = call2(Stdlib[28], cst_String_length_should_be_two, a_);

call1(Stdlib[46], b_);

var c_ = call2(Stdlib_string[1], 1, 138);
var d_ = call2(Stdlib_string[1], 1, 201);
var e_ = call2(Stdlib[28], d_, c_);
...
var index = call2(Stdlib_string[14], cst_as_df, 95);
var f_ = call1(Stdlib[33], index);
var g_ = call2(Stdlib[28], cst_index_from_string_with_char, f_);

call1(Stdlib[46], g_);

var unicodeLength = 2;

try {var D_ = call2(Stdlib_string[14], cst_asdf, 95);var index__0 = D_;}
catch(G_) {
...
var i_ = call1(Stdlib[33], index__0);
var j_ = call2(Stdlib[28], cst_index_from_string_without_char, i_);
...
var k_ = call1(Stdlib_string[12], cst_trimmed_string);
...
try {var C_ = createIntFromString(cst_WHEREAMI);var m_ = C_;}
  ...
  if (F_[1] !== Stdlib[7]) {throw caml_wrap_thrown_exception_reraise(F_);}
  var l_ = 102;
  var m_ = l_;
}

if (102 === m_) {
  call1(Stdlib[42], cst_Properly_caught_invalid_string_to_int_conversion);
  call1(Stdlib[47], 0);
}
...
try {var B_ = createIntFromString(cst_20);var o_ = B_;}
  ...
  if (E_[1] !== Stdlib[7]) {throw caml_wrap_thrown_exception_reraise(E_);}
  var n_ = 102;
  var o_ = n_;
}

if (20 === o_) {
  var p_ = call1(Stdlib[33], o_);
  var q_ = call2(
    Stdlib[28],
...
else call1(Stdlib[2], cst_Did_not_properly_catch_conversion_from_string_to_int
);
...
var one__0 = [0,r_];
var two = [0,s_];
var t_ = call1(Stdlib[30], runtime["caml_equal"](one__0, two));
var u_ = call2(Stdlib[28], cst_ARE_T, t_);

call1(Stdlib[42], u_);

call1(Stdlib[47], 0);

var v_ = call1(Stdlib[30], one__0 === two ? 1 : 0);
var w_ = call2(Stdlib[28], cst_ARE_F, v_);
...
var n = Stdlib[24];
var anotherName = Stdlib[24];
var x_ = call1(Stdlib[30], n === anotherName ? 1 : 0);
var y_ = call2(Stdlib[28], cst_Nans_are_should_output_true, x_);

call1(Stdlib[42], y_);

call1(Stdlib[47], 0);

var z_ = call1(Stdlib[30], n === anotherName ? 1 : 0);
var A_ = call2(Stdlib[28], cst_Nans_are_should_output_false, z_);
