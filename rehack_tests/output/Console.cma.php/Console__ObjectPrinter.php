  ...
  public static function get() : Vector<dynamic> {
    ...
    $getBreakData = (dynamic $itms) : dynamic ==> {
      $aa_ = (dynamic $param, dynamic $itm) : dynamic ==> {
        $curDidBreak = $param[2];
        $curTotalLen = $param[1];
        $containsNewline = $call2($String[22], $itm, 10);
      ...
      $match = $call3($List[20], $aa_, $c_, $itms);
    ...
    (dynamic $pair, dynamic $self, dynamic $depth, dynamic $o) : dynamic ==> {
      ...
      $L_ = $call2($Pervasives[16], $indent, $right);
      $M_ = $call2($Pervasives[16], $cst__10, $L_);
      $N_ = $call2($Pervasives[16], $truncationMsg, $M_);
      $O_ = $call2($Pervasives[16], $cst__11, $indentNext);
      $P_ = $call2($String[7], $O_, $itms);
      $Q_ = $call2($Pervasives[16], $P_, $N_);
      $R_ = $call2($Pervasives[16], $indentNext, $Q_);
      $S_ = $call2($Pervasives[16], $cst__12, $R_);
    ...
    $printListShape = (dynamic $self, dynamic $depth, dynamic $o) : dynamic ==> {
      ...
      $w_ = $call2($Pervasives[16], $indent, $cst__18);
      $x_ = $call2($Pervasives[16], $cst__19, $w_);
      $y_ = $call2($Pervasives[16], $truncationMsg, $x_);
      $z_ = $call2($Pervasives[16], $cst__20, $indentNext);
      $A_ = $call2($String[7], $z_, $itms);
      $B_ = $call2($Pervasives[16], $A_, $y_);
      $C_ = $call2($Pervasives[16], $indentNext, $B_);
      $D_ = $call2($Pervasives[16], $cst__21, $C_);
    ...
    $h_ = (dynamic $self, dynamic $f) : dynamic ==> {
      $t_ = $call1($Pervasives[21], (int) $f);
      $u_ = $call2($Pervasives[16], $t_, $cst__29);
    ...
    $o_ = (dynamic $self, dynamic $f) : dynamic ==> {
      return $call1($Pervasives[23], $f);
    };
    $p_ = (dynamic $self, dynamic $s) : dynamic ==> {
      $r_ = $call2($self[2], $self, $s);
      $s_ = $call2($Pervasives[16], $r_, $cst__30);
