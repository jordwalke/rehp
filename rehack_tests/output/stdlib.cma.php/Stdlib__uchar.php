...
final class Stdlib__uchar {
  ...
  public static function get() : Vector<dynamic> {
    ...
    $err_not_latin1 = (dynamic $u) : dynamic ==> {
      ...
      return $call2($Stdlib[28], $cst_U, $p_);
    };
    $min = 0 as dynamic;
    ...
    $succ = (dynamic $u) : dynamic ==> {
      return $u === 55295
        ? $hi_bound
        : ($u === 1114111
         ? $call1($Stdlib[1], $err_no_succ)
         : ((int) ($u + 1)));
    };
    $pred = (dynamic $u) : dynamic ==> {
      return $u === 57344
        ? $lo_bound
        : ($u === 0 ? $call1($Stdlib[1], $err_no_pred) : ((int) ($u + -1)));
    };
