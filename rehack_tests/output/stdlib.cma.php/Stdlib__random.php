...
final class Stdlib__random {
  ...
  public static function get() : Vector<dynamic> {
    ...
    $cst_x = $string("x");
    $Stdlib_int32 = Stdlib__int32::get();
    $Stdlib_int64 = Stdlib__int64::get();
    $Stdlib = Stdlib::get();
    $Stdlib_int = Stdlib__int::get();
    $Stdlib_digest = Stdlib__digest::get();
    $Stdlib_array = Stdlib__array::get();
    $Stdlib_nativeint = Stdlib__nativeint::get();
    ...
    $full_init = (dynamic $s, dynamic $seed) : dynamic ==> {
      ...
      $combine = (dynamic $accu, dynamic $x) : dynamic ==> {
        $q_ = $call1($Stdlib_int[10], $x);
        $r_ = $call2($Stdlib[28], $accu, $q_);
      ...
      for (;;) {
        ...
        $h_ = (int) (54 + $call2($Stdlib[17], 55, $l)) as dynamic;
        $g_ = 0 as dynamic;
        if (! ($h_ < 0)) {
          $i = $g_;
          for (;;) {
        ...
        if (
          $caml_greaterthan(
            ...
            $runtime["caml_int64_add"](
              $caml_int64_sub($Stdlib_int64[9], $n),
              $a_
            )
          )
        ) {continue;}
    ...
    $nativeint = 32 === $Stdlib_nativeint[9]
