...
var c = caml_new_string("hi");
var d = caml_new_string("hi");
var e = caml_new_string("hi");
var f = caml_new_string("hi");
var g = caml_new_string("hi");
var b = caml_new_string("hi");
var a = caml_new_string("hi");
    ...
    for (;;) {
      if (param__0) {
        ...
        try {
          ...
          if (h[1] !== Sys_error) {
            throw caml_wrap_thrown_exception_reraise(h);
          }
        }
        var param__0 = l;
        continue;
